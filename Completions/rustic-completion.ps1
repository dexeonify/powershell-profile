...
Register-ArgumentCompleter -Native -CommandName 'rustic' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'rustic' {
            ...
            [CompletionResult]::new('-g', '-g', [CompletionResultType]::ParameterName, 'Group snapshots by any combination of host,label,paths,tags, e.g. to find the latest snapshot [default: "host,label,paths"]')
            [CompletionResult]::new('--group-by', '--group-by', [CompletionResultType]::ParameterName, 'Group snapshots by any combination of host,label,paths,tags, e.g. to find the latest snapshot [default: "host,label,paths"]')
            ...
            [CompletionResult]::new('--progress-interval', '--progress-interval', [CompletionResultType]::ParameterName, 'Interval to update progress bars (default: 100ms)')
            [CompletionResult]::new('--prometheus', '--prometheus', [CompletionResultType]::ParameterName, 'Push metrics to a Prometheus Pushgateway')
            [CompletionResult]::new('--prometheus-user', '--prometheus-user', [CompletionResultType]::ParameterName, 'Authenticate to Prometheus Pushgateway using this user')
            [CompletionResult]::new('--prometheus-pass', '--prometheus-pass', [CompletionResultType]::ParameterName, 'Authenticate to Prometheus Pushgateway using this password')
            [CompletionResult]::new('--opentelemetry', '--opentelemetry', [CompletionResultType]::ParameterName, 'OpenTelemetry metrics endpoint (HTTP Protobuf)')
            ...
            [CompletionResult]::new('--warm-up-wait-command', '--warm-up-wait-command', [CompletionResultType]::ParameterName, 'Wait for end of warm up by running the command with %id replaced by pack id')
            ...
            [CompletionResult]::new('--filter-paths-exact', '--filter-paths-exact', [CompletionResultType]::ParameterName, 'Path list to filter exactly (no superset) as given (can be specified multiple times)')
            ...
            [CompletionResult]::new('--filter-tags-exact', '--filter-tags-exact', [CompletionResultType]::ParameterName, 'Tag list to filter exactly (no superset) as given (can be specified multiple times)')
            [CompletionResult]::new('--filter-after', '--filter-after', [CompletionResultType]::ParameterName, 'Only use snapshots which are taken after the given given date/time')
            [CompletionResult]::new('--filter-before', '--filter-before', [CompletionResultType]::ParameterName, 'Only use snapshots which are taken before the given given date/time')
            [CompletionResult]::new('--filter-size', '--filter-size', [CompletionResultType]::ParameterName, 'Only use snapshots with total size in given range')
            [CompletionResult]::new('--filter-size-added', '--filter-size-added', [CompletionResultType]::ParameterName, 'Only use snapshots with size added to the repo in given range')
            [CompletionResult]::new('--filter-last', '--filter-last', [CompletionResultType]::ParameterName, 'Only use the last COUNT snapshots for each group')
            [CompletionResult]::new('--filter-jq', '--filter-jq', [CompletionResultType]::ParameterName, 'jq to filter snapshots')
            [CompletionResult]::new('--profile-substitute-env', '--profile-substitute-env', [CompletionResultType]::ParameterName, 'Substitute environment variables in profiles')
            ...
            [CompletionResult]::new('--check-index', '--check-index', [CompletionResultType]::ParameterName, 'Check if index matches pack files and read pack headers if necessary')
            ...
            [CompletionResult]::new('cat', 'cat', [CompletionResultType]::ParameterValue, 'Show raw data of files and blobs in a repository')
            ...
            [CompletionResult]::new('copy', 'copy', [CompletionResultType]::ParameterValue, 'Copy snapshots to other repositories')
            [CompletionResult]::new('diff', 'diff', [CompletionResultType]::ParameterValue, 'Compare two snapshots or paths')
            [CompletionResult]::new('docs', 'docs', [CompletionResultType]::ParameterValue, 'Open the documentation')
            [CompletionResult]::new('dump', 'dump', [CompletionResultType]::ParameterValue, 'Dump the contents of a file within a snapshot to stdout')
            [CompletionResult]::new('find', 'find', [CompletionResultType]::ParameterValue, 'Find patterns in given snapshots')
            ...
            [CompletionResult]::new('key', 'key', [CompletionResultType]::ParameterValue, 'Manage keys for a repository')
            [CompletionResult]::new('list', 'list', [CompletionResultType]::ParameterValue, 'List repository files by file type')
            ...
            [CompletionResult]::new('self-update', 'self-update', [CompletionResultType]::ParameterValue, 'Update to the latest stable rustic release')
            [CompletionResult]::new('prune', 'prune', [CompletionResultType]::ParameterValue, 'Remove unused data or repack repository pack files')
            [CompletionResult]::new('restore', 'restore', [CompletionResultType]::ParameterValue, 'Restore (a path within) a snapshot')
            [CompletionResult]::new('rewrite', 'rewrite', [CompletionResultType]::ParameterValue, 'Rewrite existing snapshot(s)')
            [CompletionResult]::new('repair', 'repair', [CompletionResultType]::ParameterValue, 'Repair a snapshot or the repository index')
        ...
        'rustic;backup' {
            [CompletionResult]::new('--name', '--name', [CompletionResultType]::ParameterName, 'Backup sources defined in the config profile by the given name (can be specified multiple times)')
            ...
            [CompletionResult]::new('--stdin-command', '--stdin-command', [CompletionResultType]::ParameterName, 'Start the given command and use its output as stdin')
            ...
            [CompletionResult]::new('--time', '--time', [CompletionResultType]::ParameterName, 'Set the backup time manually (e.g. "2021-01-21 14:15:23+0000")')
            ...
            [CompletionResult]::new('--set-chunker', '--set-chunker', [CompletionResultType]::ParameterName, 'Set chunker to use. Allowed chunkers: ``rabin``, ``fixed_size``. Defaults to ``rabin`` if not set')
            [CompletionResult]::new('--set-chunk-size', '--set-chunk-size', [CompletionResultType]::ParameterName, 'Set the chunk size. For the rabin chunker this is the average chunk size. Defaults to `1 MiB` if not set')
            [CompletionResult]::new('--set-chunk-min-size', '--set-chunk-min-size', [CompletionResultType]::ParameterName, 'Set the minimum chunk size. Only used for the rabin chunker. Defaults to `512 kiB` if not set')
            [CompletionResult]::new('--set-chunk-max-size', '--set-chunk-max-size', [CompletionResultType]::ParameterName, 'Set the maximum chunk size. Only used for the rabin chunker. Defaults to `8 MiB` if not set')
            ...
            [CompletionResult]::new('--metrics-job', '--metrics-job', [CompletionResultType]::ParameterName, 'Job name for the metrics. Default: rustic-backup')
            [CompletionResult]::new('--metrics-labels', '--metrics-labels', [CompletionResultType]::ParameterName, 'Additional labels to set to generated metrics')
            [CompletionResult]::new('-P', '-P ', [CompletionResultType]::ParameterName, 'Config profile to use. This parses the file `<PROFILE>.toml` in the config directory. [default: "rustic"]')
            [CompletionResult]::new('--use-profile', '--use-profile', [CompletionResultType]::ParameterName, 'Config profile to use. This parses the file `<PROFILE>.toml` in the config directory. [default: "rustic"]')
            [CompletionResult]::new('--log-level', '--log-level', [CompletionResultType]::ParameterName, 'Use this log level [default: info]')
            [CompletionResult]::new('--log-file', '--log-file', [CompletionResultType]::ParameterName, 'Write log messages to the given file instead of printing them')
            ...
            [CompletionResult]::new('--long', '--long', [CompletionResultType]::ParameterName, 'Show detailed information about generated snapshot')
            ...
            [CompletionResult]::new('--skip-if-unchanged', '--skip-if-unchanged', [CompletionResultType]::ParameterName, 'Skip writing of snapshot if nothing changed w.r.t. the parent snapshot')
        ...
        'rustic;check' {
            [CompletionResult]::new('--read-data-subset', '--read-data-subset', [CompletionResultType]::ParameterName, 'Read only a subset of the data. Allowed values: "all", "n/m" for specific part, "x%" or a size for a random subset')
            [CompletionResult]::new('-P', '-P ', [CompletionResultType]::ParameterName, 'Config profile to use. This parses the file `<PROFILE>.toml` in the config directory. [default: "rustic"]')
            [CompletionResult]::new('--use-profile', '--use-profile', [CompletionResultType]::ParameterName, 'Config profile to use. This parses the file `<PROFILE>.toml` in the config directory. [default: "rustic"]')
            [CompletionResult]::new('-g', '-g', [CompletionResultType]::ParameterName, 'Group snapshots by any combination of host,label,paths,tags, e.g. to find the latest snapshot [default: "host,label,paths"]')
            [CompletionResult]::new('--group-by', '--group-by', [CompletionResultType]::ParameterName, 'Group snapshots by any combination of host,label,paths,tags, e.g. to find the latest snapshot [default: "host,label,paths"]')
            ...
            [CompletionResult]::new('--read-data', '--read-data', [CompletionResultType]::ParameterName, 'Also read and check pack files')
            [CompletionResult]::new('--profile-substitute-env', '--profile-substitute-env', [CompletionResultType]::ParameterName, 'Substitute environment variables in profiles')
            [CompletionResult]::new('-n', '-n', [CompletionResultType]::ParameterName, 'Only show what would be done without modifying anything. Does not affect read-only commands')
            [CompletionResult]::new('--dry-run', '--dry-run', [CompletionResultType]::ParameterName, 'Only show what would be done without modifying anything. Does not affect read-only commands')
            [CompletionResult]::new('--check-index', '--check-index', [CompletionResultType]::ParameterName, 'Check if index matches pack files and read pack headers if necessary')
        ...
        'rustic;copy' {
            [CompletionResult]::new('--target', '--target', [CompletionResultType]::ParameterName, 'Target repository (can be specified multiple times)')
            [CompletionResult]::new('--hostname', '--hostname', [CompletionResultType]::ParameterName, 'Set ''hostname'' in public key information')
            [CompletionResult]::new('--username', '--username', [CompletionResultType]::ParameterName, 'Set ''username'' in public key information')
            [CompletionResult]::new('-P', '-P ', [CompletionResultType]::ParameterName, 'Config profile to use. This parses the file `<PROFILE>.toml` in the config directory. [default: "rustic"]')
            [CompletionResult]::new('--use-profile', '--use-profile', [CompletionResultType]::ParameterName, 'Config profile to use. This parses the file `<PROFILE>.toml` in the config directory. [default: "rustic"]')
        ...
        'rustic;diff' {
            ...
            [CompletionResult]::new('--only-identical', '--only-identical', [CompletionResultType]::ParameterName, 'only show differences for identical files, this can be used for a bitrot test on the local path')
            [CompletionResult]::new('--git-ignore', '--git-ignore', [CompletionResultType]::ParameterName, 'Ignore files based on .gitignore files')
            [CompletionResult]::new('--no-require-git', '--no-require-git', [CompletionResultType]::ParameterName, 'Do not require a git repository to apply git-ignore rule')
            [CompletionResult]::new('-x', '-x', [CompletionResultType]::ParameterName, 'Exclude other file systems, don''t cross filesystem boundaries and subvolumes')
            [CompletionResult]::new('--one-file-system', '--one-file-system', [CompletionResultType]::ParameterName, 'Exclude other file systems, don''t cross filesystem boundaries and subvolumes')
        ...
        'rustic;docs' {
            ...
            [CompletionResult]::new('-h', '-h', [CompletionResultType]::ParameterName, 'Print help (see more with ''--help'')')
            [CompletionResult]::new('--help', '--help', [CompletionResultType]::ParameterName, 'Print help (see more with ''--help'')')
            [CompletionResult]::new('user', 'user', [CompletionResultType]::ParameterValue, 'Show the user documentation')
            [CompletionResult]::new('dev', 'dev', [CompletionResultType]::ParameterValue, 'Show the development documentation')
            [CompletionResult]::new('config', 'config', [CompletionResultType]::ParameterValue, 'Show the configuration documentation')
            [CompletionResult]::new('help', 'help', [CompletionResultType]::ParameterValue, 'Print this message or the help of the given subcommand(s)')
            break
        }
        'rustic;docs;user' {
        ...
        'rustic;docs;help;user' {
            break
        }
        'rustic;docs;help;dev' {
            break
        }
        'rustic;docs;help;config' {
            break
        }
        'rustic;docs;help;help' {
            break
        }
        'rustic;dump' {
            [CompletionResult]::new('--archive', '--archive', [CompletionResultType]::ParameterName, 'set archive format to use. Possible values: auto, content, tar, targz, zip. For "auto" format is dertermined by file extension (if given) or "tar" for dirs')
            [CompletionResult]::new('--file', '--file', [CompletionResultType]::ParameterName, 'dump output to the given file. Use this instead of redirecting stdout to a file')
            [CompletionResult]::new('--glob', '--glob', [CompletionResultType]::ParameterName, 'Glob pattern to exclude/include (can be specified multiple times)')
            [CompletionResult]::new('--iglob', '--iglob', [CompletionResultType]::ParameterName, 'Same as --glob pattern but ignores the casing of filenames')
            [CompletionResult]::new('--glob-file', '--glob-file', [CompletionResultType]::ParameterName, 'Read glob patterns to exclude/include from this file (can be specified multiple times)')
            [CompletionResult]::new('--iglob-file', '--iglob-file', [CompletionResultType]::ParameterName, 'Same as --glob-file ignores the casing of filenames in patterns')
        ...
        'rustic;forget' {
            ...
            [CompletionResult]::new('-M', '-M ', [CompletionResultType]::ParameterName, 'Keep the last N minutely snapshots (N == -1: keep all minutely snapshots)')
            [CompletionResult]::new('--keep-minutely', '--keep-minutely', [CompletionResultType]::ParameterName, 'Keep the last N minutely snapshots (N == -1: keep all minutely snapshots)')
            ...
            [CompletionResult]::new('--keep-within-minutely', '--keep-within-minutely', [CompletionResultType]::ParameterName, 'Keep minutely snapshots newer than DURATION relative to latest snapshot')
            ...
            [CompletionResult]::new('--delete-unchanged', '--delete-unchanged', [CompletionResultType]::ParameterName, 'Delete unchanged follow-up snapshots (i.e. with identical tree)')
        ...
        'rustic;key' {
            ...
            [CompletionResult]::new('list', 'list', [CompletionResultType]::ParameterValue, 'List all keys in the repository')
            [CompletionResult]::new('remove', 'remove', [CompletionResultType]::ParameterValue, 'Remove a key from the repository')
            [CompletionResult]::new('password', 'password', [CompletionResultType]::ParameterValue, 'Change the password of a key')
            [CompletionResult]::new('help', 'help', [CompletionResultType]::ParameterValue, 'Print this message or the help of the given subcommand(s)')
            break
        }
        'rustic;key;add' {
        ...
        'rustic;key;help;list' {
            break
        }
        'rustic;key;help;remove' {
            break
        }
        'rustic;key;help;password' {
            break
        }
        ...
        'rustic;ls' {
            ...
            [CompletionResult]::new('--json', '--json', [CompletionResultType]::ParameterName, 'show listing in json')
            [CompletionResult]::new('--numeric-uid-gid', '--numeric-uid-gid', [CompletionResultType]::ParameterName, 'show uid/gid instead of user/group')
        ...
        'rustic;rewrite' {
            [CompletionResult]::new('--set-label', '--set-label', [CompletionResultType]::ParameterName, 'Set label')
            [CompletionResult]::new('--set-time', '--set-time', [CompletionResultType]::ParameterName, 'Set the backup time (e.g. "2021-01-21 14:15:23+0000")')
            [CompletionResult]::new('--set-hostname', '--set-hostname', [CompletionResultType]::ParameterName, 'Set the host name')
            [CompletionResult]::new('--add-tags', '--add-tags', [CompletionResultType]::ParameterName, 'Tags to add (can be specified multiple times)')
            [CompletionResult]::new('--set-tags', '--set-tags', [CompletionResultType]::ParameterName, 'Tag list to set (can be specified multiple times)')
            [CompletionResult]::new('--remove-tags', '--remove-tags', [CompletionResultType]::ParameterName, 'Tags to remove (can be specified multiple times)')
            [CompletionResult]::new('--set-description', '--set-description', [CompletionResultType]::ParameterName, 'Set description')
            [CompletionResult]::new('--set-description-from', '--set-description-from', [CompletionResultType]::ParameterName, 'Read description to set from the given file')
            ...
            [CompletionResult]::new('--filter-last', '--filter-last', [CompletionResultType]::ParameterName, 'Only use the last COUNT snapshots for each group')
            [CompletionResult]::new('--filter-jq', '--filter-jq', [CompletionResultType]::ParameterName, 'jq to filter snapshots')
            [CompletionResult]::new('--remove-description', '--remove-description', [CompletionResultType]::ParameterName, 'Remove description')
        ...
        'rustic;help;docs;user' {
            break
        }
        'rustic;help;docs;dev' {
            break
        }
        'rustic;help;docs;config' {
            break
        }
        'rustic;help;dump' {
            break
        ...
        'rustic;help;key;list' {
            break
        }
        'rustic;help;key;remove' {
            break
        }
        'rustic;help;key;password' {
            break
        }
        'rustic;help;list' {
            break
